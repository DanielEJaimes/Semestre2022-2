export class IndexController {
    constructor(model, view) {
        ...
        this.nextBalota.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.generarBalota();
            });
        });
        this.balotaShow.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.bingo();
            });
        });
    ...
    llenarAleatoriosB(a) {
        ...
        this.filaB.forEach((Element, i) => {
            Element.innerHTML = '' + this.b[i];
        });
        this.filaB.forEach((elemento) => {
            elemento.addEventListener('click', () => {
    ...
    llenarAleatoriosI(a) {
        ...
        this.filaI.forEach((Element, i) => {
            Element.innerHTML = '' + this.i[i];
        });
        this.filaI.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.toggleActive(elemento);
            });
        });
    ...
    llenarAleatoriosN(a) {
        ...
        this.filaN.forEach((Element, i) => {
            Element.innerHTML = '' + this.n[i];
        });
        this.filaN.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.toggleActive(elemento);
            });
        });
    ...
    llenarAleatoriosG(a) {
        ...
        this.filaG.forEach((Element, i) => {
            Element.innerHTML = '' + this.g[i];
        });
        this.filaG.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.toggleActive(elemento);
            });
        });
    ...
    llenarAleatoriosO(a) {
        ...
        this.filaO.forEach((Element, i) => {
            Element.innerHTML = '' + this.o[i];
        });
        this.filaO.forEach((elemento) => {
            elemento.addEventListener('click', () => {
                this.toggleActive(elemento);
            });
        });
